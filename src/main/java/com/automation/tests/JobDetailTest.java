...
public class JobDetailTest extends LoginTest {
    @Test(testName = "TC413 - Verify function search on navigation", description = "Verify chức năng search trên thanh menu")
    public void verifyFunctionSearchOnNavigation() {
        try {
            ...
            ExtentTestManager.getTest().fail("TC413 - Verify function contact seller/business test failed: " + e.getMessage());
        } finally {
            MouseAnimationUtils.cleanup();
        }
    }

    @Test(testName = "TC413 - Verify function contact seller/business", description = "Verify chức năng Contact Me")
    ...
    @Test(testName = "TC416 - Verify package selection functionality", description = "Verify chức năng Continue")
    public void verifyButtonContinue() {
        try {
            ...
            ExtentTestManager.getTest().fail("TC416 - Verify package selection functionality test failed: " + e.getMessage());
        } finally {
            MouseAnimationUtils.cleanup();
        }
    }

    @Test(testName = "TC419 - Verify method Compare Package", description = "Verify chức năng Compare packages")
    public void verifyButtonCompare() {
        try {
            ...
            ExtentTestManager.getTest().fail("TC419 - Verify method Compare Package test failed: " + e.getMessage());
        } finally {
            MouseAnimationUtils.cleanup();
        }
    }
